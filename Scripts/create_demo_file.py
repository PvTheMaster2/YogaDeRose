...
def main():
    """Cria um arquivo demonstrativo do sumário do Yoga com estrutura numérica hierárquica."""
    # Conteúdo de demonstração baseado no sumário mostrado pelo usuário
    content = """# Sumário do Tratado de Yoga
...
Respiratório de natureza tamásica.
...
"""
    ...
    output_file = "00 - INBOX/02 - LITERATURE/Yoga_R00_cleaned.md"
    ...
    print(f"Arquivo demonstrativo criado em: {output_file}")
    print(f"Tamanho do arquivo: {len(content)} bytes")
    print("Você pode agora regenerar os Zettels com a estrutura hierárquica correta.")
